...
public class stat_humdity_air extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hum_air_stat);
        pd = new ProgressDialog(stat_humdity_air.this);
    ...
    public void load_data_from_server() {
        //   pd.show();
        String url = "http://172.20.10.9/irrigation/stat_humidite_air.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        BarDataSet barDataSet1 = new BarDataSet(yValues, " Capteur stat humidite d'air ");
                        barDataSet1.setColor(Color.rgb(90, 129, 60));
                        yAxis = new ArrayList<>();
