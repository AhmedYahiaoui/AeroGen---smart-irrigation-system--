...
import com.example.blackhummer.testslide.networking.ApiConfig;
import com.example.blackhummer.testslide.networking.AppConfig;
import com.example.blackhummer.testslide.networking.ServerResponse;
...
public class ImageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void captureImage() {
        if (Build.VERSION.SDK_INT > 29) { //use this if Lollipop_Mr1 (API 22) or above
